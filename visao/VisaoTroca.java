        ...
        while(true){
            ...
            switch(op) {
                ...
                case 1:
                    ...
                    if(SetorOri == null) System.out.println("SETOR DE ORIGEM NAO ENCONTRADO");
                    else if(SetorDest == null) System.out.println("SEU SETOR NÃO FOI ENCONTRADO.");
                    else if(bemTroca == null) System.out.println("BEM NÃO ENCONTRAOD");
                    else if(bemTroca.getSetor().getName().equals(SetorOri.getName())) System.out.println("O SETOR DE ORIGE NAO POSSUI ESSE BEM");
                    else {
                ...
                case 2:
                    ...
                    if(x == null) System.out.println("ID NAO ENCONTRADO.");
                    else {
                        ...
                        if(g == 1){
                            ...
                            if(k == null) System.out.println("BEM NÃO ENCONTRADO!");
                            else if(k.getSetor() != x.getSetOrigem()) System.out.println("ERROSETOR!");
                            else {
